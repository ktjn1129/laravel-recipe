<x-app-layout>
    ...
    <div class="grid grid-cols-4">
        ...
        @foreach ($popular as $p)
            <a href="{{ route('recipe.show', ['id' => $recipe['id']]) }}" class="flex flex-col items-center bg-white mb-6 border border-gray-200 rounded-lg shadow md:flex-row md:max-w-xl hover:bg-gray-100"><a href="" class="max-12 rounded overflow-hidden shadow-lg mx-4">
